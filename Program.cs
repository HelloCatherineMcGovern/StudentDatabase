               ...
               if (Gradstudent.StudName == term)
                    {
                        ...
                        Console.WriteLine($"Here's what I found: {Gradstudent.StudName}, {Gradstudent.StudId}, {Gradstudent.DateOfBirth}, {Gradstudent.GPA}, {Gradstudent.PreviousDegree}, {Gradstudent.PreviousUniversity}, {Gradstudent.UgGPA}");
...
//switch statement for updates
                        ...
                        Console.WriteLine("1) update student's info 2) return to the main menu");
                        bool validChoice;
...
foreach  (var Undergradstudent in undergradstudents)
                    ...
                    if (Undergradstudent.StudId == Idterm)
                            {
                                ...
                                Console.WriteLine($"Here's what I found: {Undergradstudent.StudName}, {Undergradstudent.StudId}, {Undergradstudent.Major}, {Undergradstudent.GPA}, {Undergradstudent.PreviousHighSchool}");
                            
                                //switch statement for updates

                                Console.WriteLine("Select 1) to update student or 2) to go back to the main menu");
                ...
                //Console.WriteLine("Please update by entering one of the following numbers for the student's classification:");
                //Console.WriteLine("1) Freshman, 2) Sophomore, 3) Junior, 4) Senior");
                //Undergradstudent.Classification = Enum.Parse<Undergradstudent.Classification>(Console.ReadLine());

                //Now we update the Undergrad list with the information from the user inputs
               
//End updating process
                            Console.WriteLine($"The Entry for the undergradGradstudent is now {Undergradstudent.StudName}, {Undergradstudent.StudId}, {Undergradstudent.Major}, {Undergradstudent.PreviousHighSchool}, {Undergradstudent.Classification}");
                            CreateMenu(gradstudents, undergradstudents);
                            validChoice = false;
                            break;
